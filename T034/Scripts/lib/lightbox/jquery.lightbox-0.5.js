...
(function(jQuey) {
    ...
    jQuery.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading:            '/Content/pic/lightbox/lightbox-ico-loading.gif',        // (string) Path and the name of the loading icon
            imageBtnPrev:            '/Content/pic/lightbox/prevlabel.gif',            // (string) Path and the name of the prev button image
            imageBtnNext:            '/Content/pic/lightbox/nextlabel.gif',            // (string) Path and the name of the next button image
            imageBtnClose:            '/Content/pic/lightbox/close_grey.png',        // (string) Path and the name of the close btn
            imageBlank:                '/Content/pic/lightbox/lightbox-blank.gif',            // (string) Path and the name of a blank image (one pixel)
            ...
            imgHeightLimit:         0,   // (integer) Limit height for shown picture. 0-no limit
            // Configuration related to texts in caption. For example: Image 2 of 8. You can alter either "Image" and "of" texts.
            txtImage:                (typeof(galleryMessages)=="object")?galleryMessages.lb_txtImage:'Photo',    // (string) Specify text "Image"
            txtOf:                   (typeof(galleryMessages)=="object")?galleryMessages.lb_txtOf: 'from',        // (string) Specify text "of"
